 ...
 */
class Version20170326191521 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE posts (id UUID NOT NULL, description VARCHAR(255) NOT NULL, author_user_id UUID NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE tags (id INT NOT NULL, tag VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
